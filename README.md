# Hi there! 👋 I'm Md Abrar Faiyaj

🧬 **Graduate Student in Biotechnology** | Passionate about computational biology and bioinformatics
...
- 🦠 Currently working on **dengue virus genomic surveillance** and variant tracking
- 💻 Building interactive dashboards and tools for biological data analysis
- 📊 Applying statistical methods and data visualization to genomic datasets
- 🌍 Contributing to public health research through open-source bioinformatics
...
### 🦟 [Bangladesh Dengue Strain Tracker](https://github.com/mdabrarfaiyaj/bangladesh-dengue-strain-tracker)
...
### 🧬 [Dengue Variant Tracker Prototype](https://github.com/mdabrarfaiyaj/dengue-variant-tracker-prototype)
...
### 🐧 [Palmer Penguins Biological Data Analysis](https://github.com/mdabrarfaiyaj/01-penguins-biological-data-analysis)
...
### 🧪 [Bioconductor Genomic Analysis](https://github.com/mdabrarfaiyaj/bioconductor-genomic-analysis)
Bridging code and biology through R - exploring Bioconductor for genomic data analysis.

### 🍺 [Yeast Genome Analysis](https://github.com/mdabrarfaiyaj/yeast-genome-analysis)
...
⭐️ Feel free to explore my repositories and reach out if you'd like to collaborate on bioinformatics projects!
